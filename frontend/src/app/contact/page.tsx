    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 py-24">
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        ...
        <div className="prose prose-emerald dark:prose-invert max-w-none">
          <p>If you have any questions, concerns, or feedback, please reach out to our support team.</p>
          <p>
            <strong>Email:</strong> support@finora.test <br/>
            (Please note this is a placeholder contact as Finora is a portfolio project).
          </p>
        </div>
      </div>
    </div>
